    ...
    statics: {
        ...
        getPrototypeBody: function() {
            return {
                ...
                * @return {Ext.panel.Tree} The tree panel which owns this node.
                */
                getOwnerTree: function() {
                    ...
                    return node.store && node.store.treeStore ? node.store.treeStore.ownerTree : undefined;
                },
                ...
                removeAll : function(destroy, suppressEvents, fromParent) {
                    ...
                    var me = this,
                        ...
                        hasRemove = suppressEvents !== true && me.hasListeners.remove,
                        treeStore,
                        node;
