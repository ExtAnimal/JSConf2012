...
Ext.define('Ext.grid.column.Action', {
    ...
    /**
     * @cfg {Object} scope
     * The scope (`this` reference) in which the `{@link #handler}`, `{@link #getClass}`, `{@link #isDisabled}` and `{@link #getTip}` fuctions are executed.
     ...
     * 
     * This Column may also be disabled on a row by row basis by configuring a {@link #isDisabled} method.
     */
    /**
